      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-grid-gutter mb-unit-4">
        {categories.map((id) => {
          ...
          return (
            <div
              key={id}
              className={`category-card relative border border-outline-variant p-unit-6 hover:border-primary transition-all group cursor-pointer ${activeTab === id ? "active" : ""}`}
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <span className="font-label-mono text-label-mono text-outline">{cat.code}</span>
              </div>
            </div>
          )
        })}
        ...
        {categories.map((id) => {
          ...
          return (
            <div key={id} className={`skill-detail-pane ${activeTab === id ? "active" : ""}`} id={`pane-${id}`}>
              <div className="border border-outline-variant p-unit-6 bg-surface-container-lowest relative overflow-hidden">
